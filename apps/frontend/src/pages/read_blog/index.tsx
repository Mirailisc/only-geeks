...
const ReadBlog = () => {
  ...
  const {data, loading, error} = useQuery<{getBlogBySlugAndUsername: Partial<Blog> & {User: Partial<Profile>}}>(BLOG_READ_QUERY, {
    variables: {
      username: username,
      slug: blogSlug
    },
  ...
  return (
    <>
      <AuthNavbar />
      <div className="flex flex-col gap-4 w-full md:w-[85vw] mx-auto">
        <BlogCard 
